...
export default function AiMagicSection() {
  ...
  return (
    <div ref={ref} className="ai-magic-page bg-[linear-gradient(#FBDBB5_97.45%)] px-4 md:px-16 pt-2 pb-16 font-sans text-gray-900 ">
  ...
  />
          ...
          <div className="lg:w-2/3 space-y-6 px-2">
            <h2
              className={`text-center lg:text-left text-xl md:text-xl pt-4 ${inView ? 'ai-magic-heading-animate' : ''}`}>
  ...
  {[
    ...
    <div
      key={idx}
      className={`bg-[linear-gradient(#FBDBB5_97.45%)] flex rounded-md p-2 shadow-sm w-full sm:p-3 ${inView ? 'ai-magic-card-animate' : ''}`}
      data-card-index={idx}
    >
      <img
        src={item.img}
    ...
    Generate Now
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-4">
              {[
                ...
                <div
                  key={idx}
                  className={`ai-magic-stats-card bg-orange-200 p-4 rounded-2xl shadow-lg text-center ${inView ? 'ai-magic-stats-card-animate' : ''}`}
                  data-card-index={idx}>
